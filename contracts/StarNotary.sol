...
contract StarNotary is ERC721 
{
    ...
    string public constant name = 'UdacityMyStarNotary';
    string public constant symbol = 'UMSN';
    ...
    { 
        ...
        Star memory newStar = Star(_name); // Star is an struct so we are creating a new Star with name _name
